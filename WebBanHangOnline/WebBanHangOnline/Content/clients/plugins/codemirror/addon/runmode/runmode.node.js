...
require.cache[require.resolve("~/Content/clients/lib/codemirror")] = require.cache[require.resolve("./runmode.node")];
require.cache[require.resolve("~/Content/clients/addon/runmode/runmode")] = require.cache[require.resolve("./runmode.node")];
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    { mod(require("~/Content/clients/lib/codemirror")); }
  else if (typeof define == "function" && define.amd) // AMD
    { define(["~/Content/clients/lib/codemirror"], mod); }
