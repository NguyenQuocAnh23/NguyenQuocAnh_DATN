...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("~/Content/clients/lib/codemirror"), require("~/Content/clients/addon/mode/simple"));
  else if (typeof define == "function" && define.amd) // AMD
    define(["~/Content/clients/lib/codemirror", "~/Content/clients/addon/mode/simple"], mod);
